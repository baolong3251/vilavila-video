...
function ContentLiked(props) {
    ...
    //         try {
    //             setContentVideo((prevState) => [...prevState,{
    //                 vid: snapshot.id, 
    //                 title: snapshot.data().title,
    //                 views: snapshot.data().views,
    //                 privacy: snapshot.data().privacy,
    ...
    return (
        <>
                ...
                
            {
                ...
                return(
                    <div className='userLikedContents_videoContainer' key={video.vid}>
                        <HorizontalVideoCard video={video} />

                        <div onClick={() => handleUnLike(props.content.id)} className='userLikedContents_videoContainer_delButton'>
                            x
                        </div>
                    </div>
                )
                ...
                
            {
                ...
                return(
                    <div className='userLikedContents_imageContainer' key={image.id}>
                        <HorizontalImageCard image={image} />

                        <div onClick={() => handleUnLike(props.content.id)} className='userLikedContents_imageContainer_delButton'>
                            x
                        </div>

                        <div className='userLikedContents_imageContainer_type'>
                            Hình ảnh
                        </div>
                    </div>
                )
